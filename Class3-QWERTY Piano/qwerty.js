...
function draw(){
    ...
    fill(100, 10, 40);
    rect(30, 20, 500, 400, 20);
    fill(0, 200, 200);
    textSize(40);
    text("FM Synth", 280, 80);
    fill(0, 200, 100);
    textSize(20);
    text("Carrier", 160 , 135);
    text("Modulator", 380, 135);
    text("Depth", 160, 250);
    text("Frequency", 380, 250);
